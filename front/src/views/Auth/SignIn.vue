            ...
            <div>
              ...
              <div>
                <form @submit.prevent="handleSubmit">
                  ...
                  <div
                    v-if="loginError"
                    class="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg dark:bg-red-900/20 dark:border-red-800"
                  >
...
// 计算属性用于判断错误类型
const isNetworkError = computed(() => loginError.value === t('auth.networkError'))

const isServerError = computed(() => loginError.value === t('auth.serverError'))
