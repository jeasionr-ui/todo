    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div class="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-gray-900">
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          <!-- 在 <div class="w-full max-w-md pt-10 mx-auto"> 中添加 -->
              ...
              <div>
                ...
                <div class="relative py-3 sm:py-5">
                  ...
                  <div class="relative flex justify-center text-sm">
                    <span class="p-2 text-gray-400 bg-white dark:bg-gray-900 sm:px-5 sm:py-2">{{ $t('auth.or') }}</span>
                  </div>
                </div>
                <form @submit.prevent="handleSubmit">
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <input v-model="email" type="email" id="email" name="email" :placeholder="$t('auth.email')"
