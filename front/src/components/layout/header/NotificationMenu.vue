<template>
  <div class="relative" ref="dropdownRef">
    ...
    >
      ...
      >
        <h5 class="text-lg font-semibold text-gray-800 dark:text-white/90">{{ $t('notification.title') }}</h5>
        ...
        <li v-for="notification in notifications" :key="notification.id" @click="handleItemClick">
          ...
          >
            <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
              <img :src="notification.userImage" :alt="$t('notification.user')" class="overflow-hidden rounded-full" />
              <span
...
// 处理通知点击事件
const handleItemClick = async (event, notificationId) => {
