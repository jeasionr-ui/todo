<template>
  <div class="p-4 sm:p-6 lg:p-8">
      ...
      <div class="lg:col-span-3">
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
          <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            ...
            <button class="edit-button" @click="isSocialAccountsModal = true">
    ...
    <!-- 社交账号编辑模态框 -->
    <Modal v-if="isSocialAccountsModal" @close="isSocialAccountsModal = false">
      <template #body>
        <div
          class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          <!-- close btn -->
          <button @click="isSocialAccountsModal = false"
          ...
          <div class="px-2 pr-14">
            <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
              {{ $t('profile.editSocialAccounts') }}
            </h4>
            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              {{ $t('profile.editSocialAccountsDesc') }}
            </p>
          </div>
          <form class="flex flex-col">
            ...
            <div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              <button @click="isSocialAccountsModal = false" type="button"
                class="flex w-full justify-center rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] sm:w-auto">
                {{ $t('common.cancel') }}
              </button>
              <button @click="saveSocialAccounts" type="button"
